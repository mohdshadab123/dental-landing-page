...
export default function HeroSection() {
  const [formData, setFormData] = useState({ name: '', mobile: '', captcha: '' });
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <div className="mt-12 grid grid-cols-2 md:grid-cols-3 gap-4">
              {[
                { label: '600+ Clinics', value: '600+' },
                { label: '1300+ Dentists', value: '1300+' },
                { label: '30 L+ Happy Patients', value: '30L+' },
                { label: '35K+ Ortho Cases', value: '35K+' },
                { label: '55K+ Implants Placed', value: '55K+' },
              ].map((stat, index) => (
